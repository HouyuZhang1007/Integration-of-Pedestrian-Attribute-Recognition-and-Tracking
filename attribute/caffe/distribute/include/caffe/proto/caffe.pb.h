...
class SPPParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional uint32 base_bin_h = 7 [default = 1];
  inline bool has_base_bin_h() const;
  inline void clear_base_bin_h();
  static const int kBaseBinHFieldNumber = 7;
  inline ::google::protobuf::uint32 base_bin_h() const;
  inline void set_base_bin_h(::google::protobuf::uint32 value);

  // optional uint32 base_bin_w = 8 [default = 1];
  inline bool has_base_bin_w() const;
  inline void clear_base_bin_w();
  static const int kBaseBinWFieldNumber = 8;
  inline ::google::protobuf::uint32 base_bin_w() const;
  inline void set_base_bin_w(::google::protobuf::uint32 value);

  // optional uint32 fineness_h = 9 [default = 2];
  inline bool has_fineness_h() const;
  inline void clear_fineness_h();
  static const int kFinenessHFieldNumber = 9;
  inline ::google::protobuf::uint32 fineness_h() const;
  inline void set_fineness_h(::google::protobuf::uint32 value);

  // optional uint32 fineness_w = 10 [default = 2];
  inline bool has_fineness_w() const;
  inline void clear_fineness_w();
  static const int kFinenessWFieldNumber = 10;
  inline ::google::protobuf::uint32 fineness_w() const;
  inline void set_fineness_w(::google::protobuf::uint32 value);

  // optional float overlap_ratio_h = 11 [default = 0];
  inline bool has_overlap_ratio_h() const;
  inline void clear_overlap_ratio_h();
  static const int kOverlapRatioHFieldNumber = 11;
  inline float overlap_ratio_h() const;
  inline void set_overlap_ratio_h(float value);

  // optional float overlap_ratio_w = 12 [default = 0];
  inline bool has_overlap_ratio_w() const;
  inline void clear_overlap_ratio_w();
  static const int kOverlapRatioWFieldNumber = 12;
  inline float overlap_ratio_w() const;
  inline void set_overlap_ratio_w(float value);
 ...
 private:
  ...
  inline void set_has_engine();
  inline void clear_has_engine();
  inline void set_has_base_bin_h();
  inline void clear_has_base_bin_h();
  inline void set_has_base_bin_w();
  inline void clear_has_base_bin_w();
  inline void set_has_fineness_h();
  inline void clear_has_fineness_h();
  inline void set_has_fineness_w();
  inline void clear_has_fineness_w();
  inline void set_has_overlap_ratio_h();
  inline void clear_has_overlap_ratio_h();
  inline void set_has_overlap_ratio_w();
  inline void clear_has_overlap_ratio_w();
  ...
  int pool_;
  int engine_;
  ::google::protobuf::uint32 base_bin_h_;
  ::google::protobuf::uint32 base_bin_w_;
  ::google::protobuf::uint32 fineness_h_;
  ::google::protobuf::uint32 fineness_w_;
  float overlap_ratio_h_;
  float overlap_ratio_w_;
...
// optional uint32 base_bin_h = 7 [default = 1];
inline bool SPPParameter::has_base_bin_h() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void SPPParameter::set_has_base_bin_h() {
  _has_bits_[0] |= 0x00000008u;
}
inline void SPPParameter::clear_has_base_bin_h() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void SPPParameter::clear_base_bin_h() {
  base_bin_h_ = 1u;
  clear_has_base_bin_h();
}
inline ::google::protobuf::uint32 SPPParameter::base_bin_h() const {
  return base_bin_h_;
}
inline void SPPParameter::set_base_bin_h(::google::protobuf::uint32 value) {
  set_has_base_bin_h();
  base_bin_h_ = value;
}

// optional uint32 base_bin_w = 8 [default = 1];
inline bool SPPParameter::has_base_bin_w() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void SPPParameter::set_has_base_bin_w() {
  _has_bits_[0] |= 0x00000010u;
}
inline void SPPParameter::clear_has_base_bin_w() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void SPPParameter::clear_base_bin_w() {
  base_bin_w_ = 1u;
  clear_has_base_bin_w();
}
inline ::google::protobuf::uint32 SPPParameter::base_bin_w() const {
  return base_bin_w_;
}
inline void SPPParameter::set_base_bin_w(::google::protobuf::uint32 value) {
  set_has_base_bin_w();
  base_bin_w_ = value;
}

// optional uint32 fineness_h = 9 [default = 2];
inline bool SPPParameter::has_fineness_h() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void SPPParameter::set_has_fineness_h() {
  _has_bits_[0] |= 0x00000020u;
}
inline void SPPParameter::clear_has_fineness_h() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void SPPParameter::clear_fineness_h() {
  fineness_h_ = 2u;
  clear_has_fineness_h();
}
inline ::google::protobuf::uint32 SPPParameter::fineness_h() const {
  return fineness_h_;
}
inline void SPPParameter::set_fineness_h(::google::protobuf::uint32 value) {
  set_has_fineness_h();
  fineness_h_ = value;
}

// optional uint32 fineness_w = 10 [default = 2];
inline bool SPPParameter::has_fineness_w() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void SPPParameter::set_has_fineness_w() {
  _has_bits_[0] |= 0x00000040u;
}
inline void SPPParameter::clear_has_fineness_w() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void SPPParameter::clear_fineness_w() {
  fineness_w_ = 2u;
  clear_has_fineness_w();
}
inline ::google::protobuf::uint32 SPPParameter::fineness_w() const {
  return fineness_w_;
}
inline void SPPParameter::set_fineness_w(::google::protobuf::uint32 value) {
  set_has_fineness_w();
  fineness_w_ = value;
}

// optional float overlap_ratio_h = 11 [default = 0];
inline bool SPPParameter::has_overlap_ratio_h() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void SPPParameter::set_has_overlap_ratio_h() {
  _has_bits_[0] |= 0x00000080u;
}
inline void SPPParameter::clear_has_overlap_ratio_h() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void SPPParameter::clear_overlap_ratio_h() {
  overlap_ratio_h_ = 0;
  clear_has_overlap_ratio_h();
}
inline float SPPParameter::overlap_ratio_h() const {
  return overlap_ratio_h_;
}
inline void SPPParameter::set_overlap_ratio_h(float value) {
  set_has_overlap_ratio_h();
  overlap_ratio_h_ = value;
}

// optional float overlap_ratio_w = 12 [default = 0];
inline bool SPPParameter::has_overlap_ratio_w() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void SPPParameter::set_has_overlap_ratio_w() {
  _has_bits_[0] |= 0x00000100u;
}
inline void SPPParameter::clear_has_overlap_ratio_w() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void SPPParameter::clear_overlap_ratio_w() {
  overlap_ratio_w_ = 0;
  clear_has_overlap_ratio_w();
}
inline float SPPParameter::overlap_ratio_w() const {
  return overlap_ratio_w_;
}
inline void SPPParameter::set_overlap_ratio_w(float value) {
  set_has_overlap_ratio_w();
  overlap_ratio_w_ = value;
}
